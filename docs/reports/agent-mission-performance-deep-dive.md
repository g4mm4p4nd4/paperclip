...
Generated: 2026-06-27T01:11:26.838Z
Status: trace_only
Receipt: /Users/mnm/Documents/Github/.paperclip/portfolio-os-cockpit/instances/default/data/ops/agent-mission-performance/runs/20260627T011126Z-agent-mission-performance-trace.json
HTML: /Users/mnm/Documents/Github/paperclip/docs/reports/agent-mission-performance-dashboard.html
...
- **WARNING Success is overclaimed when finalDisposition is implicit:** 11 sampled agent(s) had mostly default_success advanced_vision ledger rows. Treat those as weak progress until agents explicitly emit finalDisposition and receipts.
...
- **WARNING Open work is stale or owned by idle agents:** 4 sampled agent(s) have stale in-progress issues or no recent execution despite assigned work. These need manager triage, not more blind wakeups.
...
| Agent | Role | Status | Severity | Score | Runs | Failed | Completed | Open | Raw Tokens | Problems |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
Evidence Custodian | pm | idle | critical | 125 | 15 | 0 | 0 | 1 | 6018357 | wake_churn_without_closure, weak_success_disposition, output_contract_drift
VOC Researcher | researcher | idle | warning | 36 | 6 | 0 | 1 | 0 | 4399192 | weak_success_disposition, output_contract_drift
...
| Agent | Role | Status | Severity | Score | Runs | Failed | Completed | Open | Raw Tokens | Problems |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
CMO | cmo | idle | critical | 232 | 80 | 2 | 0 | 1 | 43968431 | process_loss, wake_churn_without_closure, weak_success_disposition, output_contract_drift
Chief of Staff | pm | idle | critical | 172 | 42 | 2 | 1 | 1 | 25182210 | process_loss, weak_success_disposition, output_contract_drift
Growth/Distribution | general | idle | critical | 94 | 175 | 0 | 0 | 2 | 0 | wake_churn_without_closure, weak_success_disposition, skill_budget_missing
...
CEO | ceo | idle | warning | 0 | 1 | 0 | 0 | 1 | 724504 | weak_success_disposition, output_contract_drift
