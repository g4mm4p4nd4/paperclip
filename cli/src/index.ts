...
import { registerPortfolioOsCommands } from "./commands/portfolio-os.js";
...
program
  ...
  .option("--keep-local-backups <count>", "Number of local backups to keep", (value) => Number(value), 2)
...
registerPortfolioOsCommands(program);
